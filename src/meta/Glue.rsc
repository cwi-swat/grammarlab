...
void main()
{
	...
	// Generate grammarlab::language::glue::Mutations
	G = grammarlab::extract::RascalADT2BGF::extractG(|project://grammarlab/src/grammarlab/language/SLEIR.rsc|);
	...
	//writeGlue([xbgf(importG(G2.P))],|project://grammarlab/src/meta/GlueResult.glue|);
	rhss = (k:v | [GProd p] := G2.P, choice(L) := p.rhs, line <- L, sequence(v) := line, nonterminal(k) := v[0]);
	writeFile(|project://grammarlab/src/grammarlab/language/glue/Mutations.rsc|,
		("@contributor{Vadim Zaytsev - vadim@grammarware.net - SWAT, CWI}
		 '@contributor{Generated by meta::Glue, do not edit manually!}
	...
	// Generate grammarlab::language::glue::MapSLEIR2A
	writeFile(|project://grammarlab/src/grammarlab/language/glue/MapSLEIR2A.rsc|,
	"@contributor{Vadim Zaytsev - vadim@grammarware.net - SWAT, CWI}
	'@contributor{Generated by meta::Glue, do not edit manually!}
	...
	// Extraction
	G = grammarlab::extract::RascalADT2BGF::extractG(|project://grammarlab/src/grammarlab/language/glue/Abstract.rsc|);
	...
	'
	'data GExternalType
	'	= " + intercalate("()\n\t| ",[replaceAll("GET<l>","2bgf","") | production("GGrammar",label(str l,_)) <- G.P])+
	"()\n\t;\n");
}
