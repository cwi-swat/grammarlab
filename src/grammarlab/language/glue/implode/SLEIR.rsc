...
GLUEA glimplode((GlueCommand)`<GlueKMassageAndNotYX2NotOrXY _> .`) = sleir(MassageAndNotYX2NotOrXY());
GLUEA glimplode((GlueCommand)`<GlueKMassageAndXY2NotOrNotXY _> .`) = sleir(MassageAndXY2NotOrNotXY());
GLUEA glimplode((GlueCommand)`<GlueKMassageAndYX2NotOrNotXY _> .`) = sleir(MassageAndYX2NotOrNotXY());
...
GLUEA glimplode((GlueCommand)`<GlueKMassageNotAndNotXY2OrYX _> .`) = sleir(MassageNotAndNotXY2OrYX());
GLUEA glimplode((GlueCommand)`<GlueKMassageNotAndXY2OrNotXY _> .`) = sleir(MassageNotAndXY2OrNotXY());
GLUEA glimplode((GlueCommand)`<GlueKMassageNotAndXY2OrNotYX _> .`) = sleir(MassageNotAndXY2OrNotYX());
...
GLUEA glimplode((GlueCommand)`<GlueKMassageNotOrNotXY2AndYX _> .`) = sleir(MassageNotOrNotXY2AndYX());
GLUEA glimplode((GlueCommand)`<GlueKMassageNotOrXY2AndNotXY _> .`) = sleir(MassageNotOrXY2AndNotXY());
GLUEA glimplode((GlueCommand)`<GlueKMassageNotOrXY2AndNotYX _> .`) = sleir(MassageNotOrXY2AndNotYX());
...
GLUEA glimplode((GlueCommand)`<GlueKMassageOrNotYX2NotAndXY _> .`) = sleir(MassageOrNotYX2NotAndXY());
...
GLUEA glimplode((GlueCommand)`<GlueKMassageOrYX2NotAndNotXY _> .`) = sleir(MassageOrYX2NotAndNotXY());
...
GLUEA glimplode((GlueCommand)`<GlueKRenameAllN _> <GlueNonterminal x> <GlueNonterminal y> .`) = sleir(RenameAllN("<x.name>","<y.name>"));
GLUEA glimplode((GlueCommand)`<GlueKRenameAllT _> <GlueTerminal x> <GlueTerminal y> .`) = sleir(RenameAllT("<x.name>","<y.name>"));
