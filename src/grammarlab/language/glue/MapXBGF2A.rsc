...
GLUEA glimplode((GlueCommand)`<GlueKclone _> <GlueNonterminal x> to <GlueNonterminal y> <GlueScope w> .`) = xbgf(clone("<x>","<y>",mapScope(w)));
GLUEA glimplode((GlueCommand)`<GlueKconcatT _> <GlueTerminal+ xs> into <GlueTerminal y> <GlueScope w> .`) = xbgf(concatT(["<each>" | each <- xs],"<y>",mapScope(w)));
...
GLUEA glimplode((GlueCommand)`<GlueKdowngrade _> <GlueProduction p1> to <GlueProduction p2> .`) = xbgf(downgrade(mapP(p1),mapP(p2)));
GLUEA glimplode((GlueCommand)`<GlueKeliminate _> <GlueNonterminal x> .`) = xbgf(eliminate("<x>"));
GLUEA glimplode((GlueCommand)`<GlueKequate _> <GlueNonterminal x> with <GlueNonterminal y> .`) = xbgf(equate("<x>","<y>"));
GLUEA glimplode((GlueCommand)`<GlueKextract _> <GlueProduction p> <GlueScope w> .`) = xbgf(extract(mapP(p),mapScope(w)));
GLUEA glimplode((GlueCommand)`<GlueKfactor _> <GlueSymbol e1> to <GlueSymbol e2> <GlueScope w> .`) = xbgf(factor(mapS(e1),mapS(e2),mapScope(w)));
...
GLUEA glimplode((GlueCommand)`<GlueKmassage _> <GlueSymbol e1> to <GlueSymbol e2> <GlueScope w> .`) = xbgf(massage(mapS(e1),mapS(e2),mapScope(w)));
GLUEA glimplode((GlueCommand)`<GlueKnarrow _> <GlueSymbol e1> to <GlueSymbol e2> <GlueScope w> .`) = xbgf(narrow(mapS(e1),mapS(e2),mapScope(w)));
...
GLUEA glimplode((GlueCommand)`<GlueKrenameL _> <GlueLabel x> to <GlueLabel y> .`) = xbgf(renameL("<x>","<y>"));
GLUEA glimplode((GlueCommand)`<GlueKrenameN _> <GlueNonterminal x> to <GlueNonterminal y> .`) = xbgf(renameN("<x>","<y>"));
GLUEA glimplode((GlueCommand)`<GlueKrenameS _> <GlueMark x> <GlueMark y> <GlueScope w> .`) = xbgf(renameS("<x>","<y>",mapScope(w)));
GLUEA glimplode((GlueCommand)`<GlueKrenameT _> <GlueTerminal x> to <GlueTerminal y> .`) = xbgf(renameT("<x>","<y>"));
GLUEA glimplode((GlueCommand)`<GlueKreplace _> <GlueSymbol e1> with <GlueSymbol e2> <GlueScope w> .`) = xbgf(replace(mapS(e1),mapS(e2),mapScope(w)));
GLUEA glimplode((GlueCommand)`<GlueKreroot _> <GlueNonterminal+ xs> .`) = xbgf(reroot(["<each>" | each <- xs]));
GLUEA glimplode((GlueCommand)`<GlueKsplitN _> <GlueNonterminal x> into <GlueProduction+ ps> <GlueScope w> .`) = xbgf(splitN("<x>",mapPs(ps),mapScope(w)));
GLUEA glimplode((GlueCommand)`<GlueKsplitT _> <GlueTerminal x> into <GlueTerminal+ ys> <GlueScope w> .`) = xbgf(splitT("<x>",["<each>" | each <- ys],mapScope(w)));
...
GLUEA glimplode((GlueCommand)`<GlueKunite _> <GlueNonterminal x> with <GlueNonterminal y> .`) = xbgf(unite("<x>","<y>"));
GLUEA glimplode((GlueCommand)`<GlueKunlabel _> <GlueLabel x> .`) = xbgf(unlabel("<x>"));
GLUEA glimplode((GlueCommand)`<GlueKupgrade _> <GlueProduction p1> to <GlueProduction p2> .`) = xbgf(upgrade(mapP(p1),mapP(p2)));
GLUEA glimplode((GlueCommand)`<GlueKvertical _> <GlueScope w> .`) = xbgf(vertical(mapScope(w)));
GLUEA glimplode((GlueCommand)`<GlueKwiden _> <GlueSymbol e1> to <GlueSymbol e2> <GlueScope w> .`) = xbgf(widen(mapS(e1),mapS(e2),mapScope(w)));
