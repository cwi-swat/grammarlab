...
public str ppgl(int i, int j, GExpr::except(GExpr expr1, GExpr expr2)) = "<ind(i)>except(<ppgl(0,j,expr1)>,<ppgl(0,j,expr2)>)";
...
public str ppgl(int i, int j, XCommand::downgrade(GProd p1, GProd p2)) = "<ind(i)>downgrade(<ppgl(0,j+1,p1)>,\n<ppgl(j,j,p2)>)";
...
public str ppgl(int i, int j, XCommand::massage(GExpr e1, GExpr e2, XScope w)) = "<ind(i)>massage(<ppgl(0,j+1,e1)>,\n<ppgl(j,j,e2)>,\n<ppgl(j,j,w)>)";
public str ppgl(int i, int j, XCommand::narrow(GExpr e1, GExpr e2, XScope w)) = "<ind(i)>narrow(<ppgl(0,j+1,e1)>,\n<ppgl(j,j,e2)>,\n<ppgl(j,j,w)>)";
...
public str ppgl(int i, int j, XCommand::replace(GExpr e1, GExpr e2, XScope w)) = "<ind(i)>replace(<ppgl(0,j+1,e1)>,\n<ppgl(j,j,e2)>,\n<ppgl(j,j,w)>)";
public str ppgl(int i, int j, XCommand::reroot(list[str] xs)) = "<ind(i)>reroot(<xs>)";
public str ppgl(int i, int j, XCommand::splitN(str x, GProdList ps, XScope w)) = "<ind(i)>splitN(<x>,<ppgl(0,j+1,ps)>,<ppgl(0,j+1,w)>)";
public str ppgl(int i, int j, XCommand::splitT(str x, list[str] ys, XScope w)) = "<ind(i)>splitT(<x>,<ys>,<ppgl(0,j+1,w)>)";
...
public str ppgl(int i, int j, XCommand::unfold(str x, XScope w)) = "<ind(i)>unfold(<x>,<ppgl(0,j+1,w)>)";
...
public str ppgl(int i, int j, XCommand::upgrade(GProd p1, GProd p2)) = "<ind(i)>upgrade(<ppgl(0,j+1,p1)>,\n<ppgl(j,j,p2)>)";
public str ppgl(int i, int j, XCommand::vertical(XScope w)) = "<ind(i)>vertical(<ppgl(0,j+1,w)>)";
public str ppgl(int i, int j, XCommand::widen(GExpr e1, GExpr e2, XScope w)) = "<ind(i)>widen(<ppgl(0,j+1,e1)>,\n<ppgl(j,j,e2)>,\n<ppgl(j,j,w)>)";
public str ppgl(int i, int j, XCommand::yaccify(GProdList ps)) = "<ind(i)>yaccify(<ppgl(0,j+1,ps)>)";
